...
Its role is to download information of gene a given variant is overlapping with
...
At this time, the script does not care about multiple genes.... Being honest, the output
format does not really supports multiple genes...
...
# Hardcoded links for gencode files:
our $geneBedfile    = "/nfs/team144/ds26/FunctionalAnnotation/v1.3/data/gencode.v19.annotation_20150603_sorted.bed.gz";
our $proteinBedfile = "/nfs/team144/ds26/FunctionalAnnotation/v1.3/data/gencode.v19.annotation_20150603_protein_coding_genes_sorted.bed.gz";

# If the Gencode files are missing an error message is thrown and the program is killed:
die "[Error] Gencode file was missing from expected location: $geneBedfile\n" unless -e $geneBedfile;
die "[Error] Gencode file was missing from expected location: $proteinBedfile\n" unless -e $proteinBedfile;
